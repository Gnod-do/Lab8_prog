...
public class Client implements Runnable{
     ...
     * @return Collection.
     */
    public LinkedList<StudyGroup> processRequestToServer(String commandName, String commandStringArgument,
        ...
        return serverResponse == null ? null : serverResponse.getGroupsCollection();
    }
    ...
    public boolean processScriptToServer(File scriptFile) {
        ...
        do {
            try {
                ...
                OutputerUI.error("EndConnectionToServerException - processScript");
                try {
                    connectToServer();
                    OutputerUI.info("ConnectionToServerComplete");
                } catch (ConnectionErrorException | NotInDeclaredLimitsException reconnectionException) {
    ...
    public boolean processAuthentication(String username, String password, boolean register) {
        ...
        try {
            ...
            OutputerUI.error("EndConnectionToServerException - processAuthentication");
    ...
    private void connectToServer() throws ConnectionErrorException, NotInDeclaredLimitsException {
        try {
            ...
            Outputer.print(exception.getMessage());
